<template>
  <div class="hello">
    <b-card header="오늘 해야 할 일" style="max-width: 40rem; margin: auto; margin-top: 10vh;" class="mb-2" border-variant="info" align="left">
      ...
      <b-list-group v-if="toDoItems && toDoItems.length" class="my-1">
        <b-list-group-item
          ...
          <b-col align="right">
            <b-button variant="outline-primary" v-model="toDoItem.id"
            type="text" v-on:click="deleteToDo(toDoItem)">삭제</b-button>
          </b-col>
        </b-list-group-item>
      </b-list-group>
    </b-card>
